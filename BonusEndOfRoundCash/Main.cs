...
namespace Main
{
	public class Main : MelonMod
	{
		...
		public static double cashIncrease(Simulation __instance)
		{
			...
			double increaseCashAmount = 100000.0; //change this to your liking
		...
		public override void OnApplicationStart()
		{
			...
			// MelonLogger.Msg("100000 Bonus End of Round Cash Mod Loaded!");
			// MelonLogger.Msg("Created by Roshi617. Meant to be used with Bloons Adventure Time TD. Slightly edited by Apollo???");
		}
